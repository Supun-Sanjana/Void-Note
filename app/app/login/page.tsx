...
import HashLoader  from 'react-spinners/HashLoader'; // Example spinner
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      ...
      {isLoading ? (
        <div className="flex flex-col items-center space-y-4">
          <HashLoader  color="#4F46E5" size={50} /> {/* Indigo spinner */}
          <p className="text-indigo-600 text-lg">Logging in...</p>
        </div>
      ) : (
